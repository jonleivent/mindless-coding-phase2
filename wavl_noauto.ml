...
let irot1 lw x rw g =
  ...
  | Node (_, d, lw0, rw0) ->
    (match rw0 with
     ...
     | Missing -> Node (g, d, lw0, (Node (false, x, Missing, Missing))))
...
let irot2 lw x rw g =
  ...
  | Node (_, d, lw0, rw0) ->
    (match lw0 with
     ...
     | Missing -> Node (g, d, (Node (false, x, Missing, Missing)), rw0))
  | Missing -> assert false (* absurd case *)
    ...
    (match lw0 with
     | Node (_, d0, lw1, rw1) ->
       ...
       then (DSameK, (Node (g, d, (Node (false, x, lw, lw0)), (setgap rw0 true))))
              ...
              (setgap rw0 false))))))
     | Missing -> (DSameK, (Node (g, d, (Node (true, x, Missing, Missing)), (setgap rw0 true)))))
  | Missing -> assert false (* absurd case *)
    ...
    (match rw0 with
     | Node (_, d0, lw1, rw1) ->
       ...
       then (DSameK, (Node (g, d, (setgap lw0 true), (Node (false, x, rw0, rw)))))
              ...
              (setgap rw false))))))
     | Missing -> (DSameK, (Node (g, d, (setgap lw0 true), (Node (true, x, Missing, Missing))))))
  | Missing -> assert false (* absurd case *)
